...
import { newSheet, setSheetField, toggleSheetList, hasSpur, giveStartingWeapons, TALENTS, REPUTATION, MECH_STATES, PACKS, KEEPSAKES } from './sheets.js';
...
export const META = { packs: PACKS, keepsakes: KEEPSAKES, statuses: STATUSES, capture: CAPTURE, trades: TRADES, talents: TALENTS, reputationLevels: REPUTATION, mechStates: MECH_STATES, skills: SKILLS };
